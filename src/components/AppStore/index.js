...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredList = this.getFilteredApps()
    const resultFilteredList = filteredList.filter(eachListItem =>
      eachListItem.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
      ...
      <div className="bg-container">
        <div className="content-container">
          ...
          <ul className="appItem-container">
            {resultFilteredList.map(eachApp => (
